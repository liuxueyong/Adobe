...
var wWidth = window.innerWidth > 1920 ? 1920 : window.innerWidth;
var during = parseInt(wWidth / 1920 * 20000);
var positionX = parseInt(3.5 * (wWidth / 1920) * 100);
var index = 0;
    ...
    return _this;
        ...
        function getTop(){
            ...
            var distance = parseInt(40 * wWidth / 1920)
